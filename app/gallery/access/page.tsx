      ...
      <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-slate-600">
            Signed-in viewers use a short gallery code to enter the private exhibition space.
          </p>
        </div>
        <div className="mx-auto mt-12 max-w-xl">
          <Card className="p-2">
            <CardHeader>
              ...
              <CardDescription>Use the code shared by the organizers in your event invite.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              <form action={grantGalleryAccessAction} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input id="code" name="code" placeholder="SPRING24" autoCapitalize="characters" required />
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 pt-2 text-xs font-medium uppercase tracking-[0.18em] text-slate-500">
                ...
                <span className="rounded-full bg-sky-100 px-3 py-1 text-sky-800">Code required</span>
